...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { description: @event_type.description, number: @event_type.number, short_decription: @event_type.short_decription }
    end
  ...
  test "should update event_type" do
    put :update, id: @event_type, event_type: { description: @event_type.description, number: @event_type.number, short_decription: @event_type.short_decription }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
